                        ...
                        <div className="rounded shadow bg-white dark:bg-slate-900 p-6">
                            ...
                            {success && (
                                <div className="mt-4 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-md">
                                    <p className="text-green-600 dark:text-green-400 text-sm">Account created successfully! Redirecting to login...</p>
                                </div>
                            )}
                            ...
                            <form onSubmit={handleSubmit} className="text-start mt-4">
                                <div className="grid grid-cols-1">
                                    <div className="mb-4">
                                        <label className="font-semibold" htmlFor="SignupEmail">Email Address:</label>
                                        <input 
                                            id="SignupEmail" 
                                            type="email" 
                                            value={email}
                                    ...
                                    <div className="mb-4">
                                        <label className="font-semibold" htmlFor="SignupPassword">Password:</label>
                                        <input 
                                            id="SignupPassword" 
                                            type="password" 
                                            value={password}
